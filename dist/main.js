...
var match = function match(text, query) {
  ...
  return query.trim().split(whitespacesRegex)
    ...
    value: function render() {
      ...
      return _react.createElement(
        ...
        _react.createElement(
          ...
          this.state.isLoading ? _react.createElement(Spinner, null) : _react.createElement(dist$5, {

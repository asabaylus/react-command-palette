  ...
  */
  ...
  function (_React$Component) {
    ...
    function CommandPalette() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(CommandPalette).call(this)); // Autosuggest is a controlled component.
      ...
      _this.onChange = _this.onChange.bind(_assertThisInitialized(_assertThisInitialized(_this))); // eslint-disable-next-line prettier/prettier

      _this.onSuggestionsFetchRequested = _this.onSuggestionsFetchRequested.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    ...
    _createClass(CommandPalette, [{
      ...
      value: function onSuggestionSelected(event, _ref2) {
        ...
        if (typeof suggestion.item.command === "function") {
          ...
          override(suggestion.item, "command", after(function () {
            _this3.setState({
              isLoading: true
            }, function () {// console.log("Show Spinner", that.state.isLoading);
            });
          }));
      ...
      value: function getSuggestions() {
        ...
        var options = this.props.options; // return all commands when user didnt suggest a specific term
        ...
        var fuse$$1 = new Fuse(suggestions, options);
      ...
      value: function focusInput() {
        ...
        var hotKeys = this.props.hotKeys;
        mousetrap(this.commandPaletteInput.input).bind(["esc", hotKeys], function () {
      ...
      value: function render() {
        ...
        }, isLoading ? React.createElement(Spinner, null) : this.renderAutoSuggest(suggestions, value)));
      }
    }]);
